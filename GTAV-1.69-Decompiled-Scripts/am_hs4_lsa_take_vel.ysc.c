#region Local Var
	...
	var uScriptParam_128 = 1176255488;
	var uScriptParam_129 = 1;
	var uScriptParam_130 = -1;
	var uScriptParam_131 = -1;
#endregion
...
int _GET_LOBBY_SCRIPT_EVENT_BITS(BOOL includeLocalPlayer, BOOL includeSpectators) // Position - 0x2331
{
	int address;
	int i;
	Player player;
