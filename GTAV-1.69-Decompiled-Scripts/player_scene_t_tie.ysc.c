...
int func_6(int iParam0, Ped pedParam1) // Position - 0x217
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (pedParam1 == func_7(Global_101254) && pedParam1 != 0)
		{
			Global_101254 = 0;
		}
	}
...
Ped func_7(Ped pedParam0) // Position - 0x2FB
{
	return pedParam0;
}
...
void func_10() // Position - 0x35A
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_113969.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_11(character) && !func_15(14) || Global_112917)
			{
				if (Global_113969.f_2366.f_539.f_4321 != character && func_11(Global_113969.f_2366.f_539.f_4321))
...
char* func_33(Hash hParam0) // Position - 0x9171
{
	switch (hParam0)
	{
